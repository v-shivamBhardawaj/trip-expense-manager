...
export const SERVICE_ONE = 'http://service1.yatra.com';

export const LOCAL_URL = `http://localhost:8040`;
...
export const USER_PROFILE_ENDPOINT = `${SERVICE_ONE}/single-signon-service/services/corporate-login-service/corporate/session/loginInfo/complete`;

export const LOGIN_URL = '/social/custom/crp/login.htm?'
export const SESSION_TIMEOUT_TIMER = 1800000
export const TIMEOUT = 2500
export const MAIN_DATA_URL = `http://pokeapi.co/api/v2/pokemon/ditto`;
